# Obstacle sensor qwiic Hardware Design

## About the Product

| ![Obstacle sensor qwiic Image](https://solde.red/333004/image) |
| :----------------------------------------------------------: |
| [Buy Obstacle sensor qwiic](https://www.solde.red/333004) |
...
The TCRT5000 operates on a supply voltage typically ranging from 3.3V to 5V. The breakout board provides digital and analog information through the qwiic system. Sensor readings are obtained through qwiic.

---

## Repository Contents

This repository contains all design files for Obstacle sensor qwiic, organized as follows:
